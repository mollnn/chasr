...
def get_pad_seq(text_lines, maxlen=48):
...
#     K.set_learning_phase(1) #set learning phase
    ...
    model.fit(x=x_train2, y=y_train2, batch_size=32, epochs=1000, validation_data=(x_test2, y_test2),initial_epoch =0,callbacks=[csv_to_log,metric_cb_test,metric_cb_train,checkpointer,lr_change])